...
export default function Dashboard({ auth }: PageProps) {
  ...
  return (
    <AppLayout
      renderHeader={() => {
        return <h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Dashboard</h2>
      }}
    >
                                ...
                                <DialogContent className="flex w-[480px] flex-col px-0 py-0">
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      px-4 py-4 dark:bg-transparent ${selectedValue === "free-trial"
                                    ...
                                    >
                                      <div
                                        className={`flex items-center justify-between rounded-lg border border-gray-200
                                      px-4 py-4 dark:bg-transparent ${selectedValue === "pro"
                                            ? "border-blue-600 bg-blue-200 dark:border-blue-500"
                                            : "dark:border-gray-800"
                                          }`}
                                      >
                        ...
                        >
                          <div className="flex gap-1">
                            <button
                              ...
                              className={`${selectedToggle === "laugh"
                                ? "bg-blue-100"
                                : "bg-transparent"
                            ...
                            <button
                              ...
                              className={`${selectedToggle === "smile"
                                ? "bg-blue-100"
                                : "bg-transparent"
                                } flex h-8 w-8 items-center justify-center rounded-full`}
                            >
                            ...
                            <button
                              ...
                              className={`${selectedToggle === "frown"
                                ? "bg-blue-100"
                                : "bg-transparent"
                                } flex h-8 w-8 items-center justify-center rounded-full`}
                            >
                    ...
                    <Dialog>
                      <ContextMenu>
                       ...
                       dark:border dark:border-neutral-800 dark:bg-neutral-900"
                             ...
                             py-4 dark:bg-transparent ${selectedValue === "free-trial"
                                        ? "border-blue-600 bg-blue-200 dark:border-blue-500"
                                        : "dark:border-gray-800"
                                      }`}
                                  >
                                ...
                                >
                                  <div
                                    className={`flex items-center justify-between rounded-lg border border-gray-200 px-4
                             py-4 dark:bg-transparent ${selectedValue === "pro"
                                        ? "border-blue-600 bg-blue-200 dark:border-blue-500"
                                        : "dark:border-gray-800"
                                      }`}
                                  >
                       ...
                       text-sm font-semibold text-neutral-600 hover:bg-neutral-200 dark:text-neutral-300 hover:dark:bg-neutral-700"
                        ...
                        <DialogContent className="flex flex-col items-center justify-center px-0 py-0">
                          ...
                          >
                           ...
                           py-5 dark:border-neutral-800 hover:dark:border-neutral-600 ${selectedOption === "edgeconfig"
                              ...
                              <label htmlFor="kv" className="w-full">
                                <div
                                  className={`flex w-full cursor-pointer flex-col items-center gap-1 rounded-md border px-3
                           py-5 dark:border-neutral-800 hover:dark:border-neutral-600 ${selectedOption === "kv"
                                      ? "border-neutral-600 bg-neutral-50 dark:border-white dark:bg-transparent hover:dark:border-white"
                                      : ""
                                    }`}
                                >
                            ...
                            <div className="mt-2 flex w-full justify-center gap-2">
                              <label htmlFor="postgres" className="w-full">
                                <div
                                  className={`flex w-full cursor-pointer flex-col items-center gap-1 rounded-md border px-3
                           py-5 dark:border-neutral-800 hover:dark:border-neutral-600 ${selectedOption === "postgres"
                                      ? "border-neutral-600 bg-neutral-50 dark:border-white dark:bg-transparent hover:dark:border-white"
                                      : ""
                                    }`}
                                >
                              ...
                              <label htmlFor="blob" className="w-full">
                                <div
                                  className={`flex w-full cursor-pointer flex-col items-center gap-1 rounded-md border px-3
                           py-5 dark:border-neutral-800 hover:dark:border-neutral-600 ${selectedOption === "blob"
                                      ? "border-neutral-600 bg-neutral-50 dark:border-white dark:bg-transparent hover:dark:border-white"
                                      : ""
                                    }`}
                                >
